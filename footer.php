...
$footerMinimal = !empty($footerMinimal);
...
?>
<footer class="mp-footer<?= $footerMinimal ? ' mp-footer-compact' : '' ?>">
  <div class="mp-footer-shell<?= $footerMinimal ? ' mp-footer-shell-compact' : '' ?>">
    <?php if ($footerMinimal): ?>
      <div class="mp-footer-compact-inner">
        <form class="mp-footer-language-form mp-footer-language-form-compact" method="POST" action="<?= $footerBasePath ?>includes/set_language.php">
        ...
        <div class="mp-footer-bottom mp-footer-bottom-compact">
...
<script>
  (function() {
    ...
    var languageSelects = document.querySelectorAll('.mp-footer-language-select');
